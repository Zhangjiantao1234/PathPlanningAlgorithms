...
namespace LStar
{
    public class LStarAlgorithmHelper 
    {
        public LStarAlgorithmHelper()
        {
            HeursticInfo =  new LStarHeurstic() {HeuristicFunc = HeuristicFunction.Euclidean };
        }

        /// <summary>
        /// 计算启发式获取的类；
        /// </summary>
        public LStarHeurstic HeursticInfo { get; set; } 
    ...
    public class LStarHeurstic
    {
        public LStarHeurstic()
        {
            StartNode = null;
            TargetNode = null;
            HeuristicFunc = null;
